...
Env vars:
    ...
    MIGRATION_DESTINATIONS  comma-separated, e.g. "bigquery,snowflake"
...
from data_migration_scripts.operational_tables_migration import run as run_migration
...
def main() -> int:
    ...
    destinations = [
        ...
        for d in os.environ.get(
            "MIGRATION_DESTINATIONS", "bigquery,snowflake"
        ).split(",")
        if d.strip()
    ]
